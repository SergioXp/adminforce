...
Class User extends CI_Model {
    ...
    function login($username, $password) {
        log_message('debug', 'Modelo user Metodo login()');
    ...
    function checkPassword($password) {
        log_message('debug', 'Modelo user Metodo checkPassword(' . MD5($password) . ')');
    ...
    function changePassword($password) {
        log_message('debug', 'Modelo user Metodo changePassowrd(' . $password . ')');
